    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className={`flex-1 flex flex-col items-center justify-center ${isNavOpen ? 'ml-64' : ''}`}>
                ...
                <button onClick={goBackToHomePage} className="px-4 py-2 rounded bg-[#517028] text-white mb-4 hover:bg-[#294a26]">
                            ...
                            {alarms.map((alarm, index) => (
                                <React.Fragment key={index}>
                                    <tr className="text-black">
                                        ...
                                        <td className="p-2">
                                            {alarm.time ? new Date
('1970-01-01T' + alarm.time).toLocaleTimeString('en-US', { hour12: true }) : ''}
</td>
<td className="p-2">
